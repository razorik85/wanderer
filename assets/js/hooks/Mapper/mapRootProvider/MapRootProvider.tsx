...
export enum InterfaceStoredSettingsProps {
  ...
  signatureCountWormholes = 'signatureCountWormholes',
  signatureCountRelicSites = 'signatureCountRelicSites',
  signatureCountDataSites = 'signatureCountDataSites',
  signatureCountGasSites = 'signatureCountGasSites',
  signatureCountOreSites = 'signatureCountOreSites',
  signatureCountCombatSites = 'signatureCountCombatSites',
  signatureCountUnknown = 'signatureCountUnknown',
