defmodule WandererApp.Map.Server.Impl do
  ...
  defdelegate update_connection_wormhole_type(map_id, connection_update), to: ConnectionsImpl
  defdelegate update_connection_mass_tracking(map_id, connection_update), to: ConnectionsImpl
